...
class PaymentCustomer extends CI_Controller
{
  ...
  public function create($id)
  {
    ...
    if ($bill) {
      ...
      // Check if the bill is already paid or being processed
      if ($bill->status === 'PAID') {
    ...
    $id_user = $this->session->userdata('id_user'); // Ensure this retrieves a valid user ID
    ...
    if ($this->form_validation->run() == false) {
      ...
      $data_pay = [
        ...
        'id_user' => $id, // Assign user ID here
      ...
      if ($this->db->trans_status() === FALSE) {
        ...
        // If transaction succeeds, commit
